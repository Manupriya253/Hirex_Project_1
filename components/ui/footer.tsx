...
export default function Footer() {
  return (
    <footer className="relative bg-black text-white">
      {/* === Footer Illustration (Background) === */}
      <div
        ...
        <div className="grid grid-cols-2 justify-between gap-12 py-8 sm:grid-rows-[auto_auto] md:grid-cols-4 md:grid-rows-[auto_auto] md:py-12 lg:grid-cols-[repeat(4,minmax(0,140px))_1fr] lg:grid-rows-1 xl:gap-20">
          ...
          <div className="space-y-2">
            ...
            <ul className="space-y-2 text-sm">
              {["Features", "Integrations", "Pricing & Plans", "Changelog", "Our method", "User policy"].map((item, index) => (
                <li key={index}>
                  <a className="text-indigo-200/65 transition hover:text-indigo-500" href="#0">{item}</a>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div className="space-y-2">
            ...
            <ul className="space-y-2 text-sm">
              {["About us", "Diversity & Inclusion", "Blog", "Careers", "Financial statements"].map((item, index) => (
                <li key={index}>
                  <a className="text-indigo-200/65 transition hover:text-indigo-500" href="#0">{item}</a>
                </li>
              ))}
          ...
          <div className="space-y-2">
            ...
            <ul className="space-y-2 text-sm">
              {["Community", "Terms of service", "Report a vulnerability"].map((item, index) => (
                <li key={index}>
                  <a className="text-indigo-200/65 transition hover:text-indigo-500" href="#0">{item}</a>
                </li>
              ))}
          ...
          <div className="space-y-2">
            ...
            <ul className="space-y-2 text-sm">
              {["Templates", "Tutorials", "Knowledge base", "Learn", "Cookie manager"].map((item, index) => (
                <li key={index}>
                  <a className="text-indigo-200/65 transition hover:text-indigo-500" href="#0">{item}</a>
                </li>
              ))}
          ...
          <div className="col-span-2 md:col-span-4 lg:col-span-1 lg:text-right">
            ...
            <div className="text-sm">
              <p className="mb-3 text-indigo-200/65">
                ...
                <a className="text-indigo-200/65 transition hover:text-indigo-500" href="#0">Terms</a>
              </p>
              <ul className="inline-flex gap-1">
                ...
                {/* Medium */}
                <li>
                  <a className="flex items-center justify-center text-indigo-500 transition hover:text-indigo-400" href="#0" aria-label="Medium">
                    <svg className="h-8 w-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
