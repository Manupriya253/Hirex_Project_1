          ...
          <div className="pb-12 text-center md:pb-20">
            ...
            <div className="mx-auto max-w-3xl">
              ...
              <div data-aos="fade-up" data-aos-delay={400}>
                  <a
                  className="btn group mb-4 w-full bg-gradient-to-t from-[#0046AD] to-[#3AD6DF] bg-[length:100%_100%] bg-bottom text-white shadow-[inset_0px_1px_0px_0px_rgba(255,255,255,0.16)] hover:bg-[length:100%_150%] sm:mb-0 sm:w-auto transition-all duration-300"
                  href="#0"
                >
